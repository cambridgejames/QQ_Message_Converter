...
public class FileMessage extends ThreeMessageBody implements Serializable {
	private static final long serialVersionUID = 1L;
	
	private boolean isDrawed;

	public FileMessage() { super(MessageStyle.FILE_CONTENT); }
	public FileMessage(String iconPath, String fileName, String fileSize) {

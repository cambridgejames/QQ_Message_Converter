...
public class PhoneCallMessage extends MessageBody implements Serializable {
	private static final long serialVersionUID = 1L;
	public static enum IconStyle {NOT_ANSWERED, CALL_OVER};

	private boolean isDrawed;
	private IconStyle iconStyle;
	private String content;
	
	public PhoneCallMessage() { super(MessageStyle.PHON_CALL_CONTENT); }
	public PhoneCallMessage(IconStyle iconStyle, String content) {

...
public class LuckyMoneyMessage extends MessageBody implements Serializable {
	...
	public LuckyMoneyMessage() { super(MessageStyle.LIMI_EXPRESSION_CONTENT); }
	public LuckyMoneyMessage(IconStyle iconStyle, String content) {
